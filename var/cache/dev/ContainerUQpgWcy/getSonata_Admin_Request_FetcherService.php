...
class getSonata_Admin_Request_FetcherService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['sonata.admin.request.fetcher'])) {
            return $container->privates['sonata.admin.request.fetcher'];
        }

        return $container->privates['sonata.admin.request.fetcher'] = new \Sonata\AdminBundle\Request\AdminFetcher($a);
    }
}
