...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'sonata.admin.command.explain' => ['privates', '.sonata.admin.command.explain.lazy', 'get_Sonata_Admin_Command_Explain_LazyService', true],
            'sonata.admin.command.generate_object_acl' => ['privates', '.sonata.admin.command.generate_object_acl.lazy', 'get_Sonata_Admin_Command_GenerateObjectAcl_LazyService', true],
            'sonata.admin.command.list' => ['privates', '.sonata.admin.command.list.lazy', 'get_Sonata_Admin_Command_List_LazyService', true],
            'sonata.admin.command.setup_acl' => ['privates', '.sonata.admin.command.setup_acl.lazy', 'get_Sonata_Admin_Command_SetupAcl_LazyService', true],
            ...
            'maker.auto_command.make_sonata_admin' => ['privates', '.maker.auto_command.make_sonata_admin.lazy', 'get_Maker_AutoCommand_MakeSonataAdmin_LazyService', true],
        ], [
            ...
            'sonata.admin.command.generate_object_acl' => '?',
            'sonata.admin.command.list' => '?',
            'sonata.admin.command.setup_acl' => '?',
