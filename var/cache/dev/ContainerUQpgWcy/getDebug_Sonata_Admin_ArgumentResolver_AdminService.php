...
class getDebug_Sonata_Admin_ArgumentResolver_AdminService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.sonata.admin.argument_resolver.admin'])) {
            return $container->privates['debug.sonata.admin.argument_resolver.admin'];
        }

        return $container->privates['debug.sonata.admin.argument_resolver.admin'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Sonata\AdminBundle\ArgumentResolver\AdminValueResolver($a), ($container->privates['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
}
