...
class getSonata_Admin_Builder_OrmDatagridService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sonata.admin.builder.orm_datagrid'] = new \Sonata\DoctrineORMAdminBundle\Builder\DatagridBuilder($a, new \Sonata\AdminBundle\Filter\FilterFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'Sonata\\DoctrineORMAdminBundle\\Filter\\UidFilter' => [false, 'sonata.admin.orm.filter.type.uid', 'getSonata_Admin_Orm_Filter_Type_UidService', true],
            'Sonata\\TranslationBundle\\Filter\\TranslationFieldFilter' => [false, 'sonata_translation.filter.type.translation_field', 'getSonataTranslation_Filter_Type_TranslationFieldService', true],
        ], [
            ...
            'Sonata\\DoctrineORMAdminBundle\\Filter\\UidFilter' => '?',
