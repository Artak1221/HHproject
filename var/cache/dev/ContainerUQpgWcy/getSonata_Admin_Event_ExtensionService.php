...
class getSonata_Admin_Event_ExtensionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['sonata.admin.event.extension'])) {
            return $container->privates['sonata.admin.event.extension'];
        }

        return $container->privates['sonata.admin.event.extension'] = new \Sonata\AdminBundle\Event\AdminEventExtension($a);
    }
}
