 ...
 */
class getSonata_Admin_Orm_Filter_Type_UidService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'sonata-project'.\DIRECTORY_SEPARATOR.'doctrine-orm-admin-bundle'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Filter'.\DIRECTORY_SEPARATOR.'UidFilter.php';

        $container->factories['service_container']['sonata.admin.orm.filter.type.uid'] = function () use ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\UidFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.uid']();
    }
}
