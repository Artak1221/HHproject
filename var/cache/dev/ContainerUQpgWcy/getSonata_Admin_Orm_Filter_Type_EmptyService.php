 ...
 */
class getSonata_Admin_Orm_Filter_Type_EmptyService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'sonata.admin.orm.filter.type.empty' service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['sonata.admin.orm.filter.type.empty'] = function () use ($container) {
            return new \Sonata\DoctrineORMAdminBundle\Filter\EmptyFilter();
        };

        return $container->factories['service_container']['sonata.admin.orm.filter.type.empty']();
    }
}
