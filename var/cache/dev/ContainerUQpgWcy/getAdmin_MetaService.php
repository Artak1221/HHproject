 ...
 */
class getAdmin_MetaService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'admin.meta' autowired service.
     *
     * @return \App\Admin\MetaAdmin
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'MetaAdmin.php';
        ...
        $container->factories['admin.meta'] = function () use ($container) {
            $instance = new \App\Admin\MetaAdmin();
            ...
            $instance->setTemplateRegistry(($container->services['admin.meta.template_registry'] ?? $container->load('getAdmin_Meta_TemplateRegistryService')));
            ...
            $instance->addExtension(($container->privates['sonata_translation.admin.extension.gedmo_translatable'] ?? $container->load('getSonataTranslation_Admin_Extension_GedmoTranslatableService')));
            $instance->initialize();

            return $instance;
        };

        return $container->factories['admin.meta']();
    }
}
