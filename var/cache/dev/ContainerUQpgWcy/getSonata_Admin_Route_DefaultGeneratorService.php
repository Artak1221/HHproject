...
class getSonata_Admin_Route_DefaultGeneratorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['sonata.admin.route.default_generator'])) {
            return $container->privates['sonata.admin.route.default_generator'];
        }

        return $container->privates['sonata.admin.route.default_generator'] = new \Sonata\AdminBundle\Route\DefaultRouteGenerator($a, ($container->privates['sonata.admin.route.cache'] ??= new \Sonata\AdminBundle\Route\RoutesCache(($container->targetDir.''.'/sonata/admin'), true)));
    }
}
