...
class getSonata_Form_Type_DatetimePickerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sonata.form.type.datetime_picker'] = new \Sonata\Form\Type\DateTimePickerType(($container->privates['sonata.form.date.moment_format_converter'] ??= new \Sonata\Form\Date\MomentFormatConverter()), ($container->services['translator'] ?? $container->getTranslatorService()), 'en');
    }
}
